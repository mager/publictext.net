...
<div id="form">
  <form method="post" action="chat.php">
    ...
    <p><button class="slick-black" type="submit">Start chatting!</button></p>
	<p id="locating">Locating you...</p>
